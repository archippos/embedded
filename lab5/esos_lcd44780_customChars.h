//team "keith help"
//anyways we need some custom characters for this display
//thx erin for finding the font table for the lcd. xoxo ily
//but really the main thing this thing does is defines for the bars and sl;iders
...
//statics for our horizontal bar (potentiopioioioioiometer)
//the horiz bar is split into eights across the bottom of the screen
...
//statics for the vertical bar (temperature?)
//the vertical bar is split into fifths across the right of the screen
//there is an underlying line to make it less ugly ig
...
//told my sponsor i dont like bars i can freestyle
